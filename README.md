...
- **Автоматическое резервное копирование по расписанию (Celery Beat)**
  - Поддержка расписаний: hourly, daily, weekly, monthly
  - Управление через Django Admin (Web UI в разработке)
  - См. [CELERY_BEAT_SETUP.md](CELERY_BEAT_SETUP.md) для настройки
- Monaco Editor для просмотра конфигураций с подсветкой синтаксиса
- 4 готовые темы оформления
